  ...
  return (
    <div className="w-full px-2 sm:px-6 md:px-10 py-10 sm:py-20 md:py-32">
      <div className="container mx-auto">
        <div className="flex gap-4 flex-col items-start ml-[20px] mr-[20px]">
          <div>
            <Badge>Développement Fullstack</Badge>
          </div>
          <div className="flex gap-2 flex-col">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#000] tracking-tighter lg:max-w-[44rem] font-regular">
          ...
          <div className="flex gap-8 sm:gap-10 pt-8 sm:pt-12 flex-col w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
              <div className="flex flex-row gap-4 sm:gap-6 w-full items-start">
                ...
                <div className="flex flex-col gap-1 text-[#000]">
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Création d’interfaces réactives et intuitives avec React,
              ...
              <div className="flex flex-row gap-4 sm:gap-6 items-start">
                ...
                <div className="flex flex-col gap-1 text-[#000]">
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Mise en place d’API performantes, gestion de bases de
                    données (MySQL, PostgreSQL) et sécurité des données.
                  </p>
                </div>
              </div>
              <div className="flex flex-row gap-4 sm:gap-6 items-start">
                ...
                <div className="flex flex-col gap-1 text-[#000]">
                  <p className="text-base sm:text-lg font-semibold">
                    Projet sur-mesure & expérience utilisateur
                  </p>
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Adaptation à vos besoins, design personnalisé et
