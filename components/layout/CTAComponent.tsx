...
export default function CTABlackComponent() {
  ...
  return (
    <motion.section
      ...
      className="py-14 px-8 xs:px-10 sm:px-14 md:px-24 bg-white relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <motion.h2
          variants={item}
          className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-6 text-black"
        >
        ...
        <motion.p
          variants={item}
          className="text-base sm:text-lg text-black mb-8 max-w-2xl mx-auto"
        >
